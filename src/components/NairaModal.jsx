...
import { cashTransfer } from "../services/firebase";
      ...
      <Modal ref={ref}>
        {!sucessful && (
          <div>
            ...
            <ModalInputContainer>
              <ModalDetails>
                <ModalLabel>Email Address of Beneficiary</ModalLabel>
                <ModalInput
                  type="email"
        ...
        {sucessful && (
          <div style={{ textAlign: "center" }}>
            ...
            <p>
              You sent ₦{amount.toLocaleString("en-US")}.00 to{" "}
              {beneficiaryEmail}
            </p>
          </div>
        )}
