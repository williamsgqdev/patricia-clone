...
import { btcTransfer } from "../services/firebase";
  ...
  return (
    <Container>
      <Modal ref={ref}>
        {!sucessful && (
          <div>
            <ModalTitle>Send Btc</ModalTitle>
            {error && (
              <div
            ...
            <ModalInputContainer>
              <ModalDetails>
                <ModalLabel>Btc Address of receiver</ModalLabel>
                <ModalInput
                  type="email"
              ...
              <ModalDetails>
                <ModalLabel>Amount ( btc)</ModalLabel>
                <ModalInput
                  type="number"
        ...
        {sucessful && (
          <div style={{ textAlign: "center" }}>
            ...
            <p>
              You sent {amount} btc to {beneficiaryAddress}
            </p>
          </div>
        )}
      </Modal>
